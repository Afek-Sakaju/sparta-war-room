...
const imagePathToBuffer = (imagePath) => fs.readFileSync(imagePath);
    ...
    await db.collection('tactics').insertMany([
      {
        ...
        image: imagePathToBuffer('../src/assets/images/phalanx.jpg'),
        information:
      ...
      },
      {
        ...
        image: imagePathToBuffer('../src/assets/images/xiphos.jpeg'),
      ...
      },
      {
        ...
        image: imagePathToBuffer('../src/assets/images/valley.jpg'),
      ...
      },
      {
        ...
        image: imagePathToBuffer('../src/assets/images/war-cry.jpg'),
